...
exports.delete_online_course = async (req,res) => {
    ...
    try{
        ...
        res.status(200).json(DeleteCourse)
            ...
            let msg = "Deleting Restricted As this course Is applied by Some students and still active";
            console.error(msg);
            res.status(409).json({ msg: "Deleting Restricted As this course Is applied by Some students and still active" }); // Use status 409 (Conflict)
        }
    }
    catch(err){
