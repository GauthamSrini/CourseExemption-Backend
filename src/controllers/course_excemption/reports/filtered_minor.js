...
exports.filter_minor_report = async (req, res) => {
  ...
  try {
    ...
    filters.push(`ce_addon_honor_minor_registered.approval_status = 3 AND ce_addon_honor_minor_registered.status = '1' AND ce_addon_honor_minor_registered.mode_of_exemption = 3 `);
